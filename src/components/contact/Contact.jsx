...
function Contact() {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_48y1gc9', 'template_8klsxeu', form.current, 'Vte4cM3NYDbIv-JZM')
       e.target.reset()
    };
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">ksitizchaturvedi@gmail.com</span>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">7417598875</span>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">@kshitij6336</span>
